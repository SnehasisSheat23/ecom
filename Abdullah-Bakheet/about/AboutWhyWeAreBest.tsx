                    ...
                    {reasons.map((reason, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Image Block */}
                                <div className="w-full md:w-[45%] h-[300px] md:h-auto min-h-[260px] bg-gray-100 relative m-4 md:m-8 overflow-hidden group">
                                    <Image
                                        src={reason.image}
                                        alt={reason.title}
                                        fill
